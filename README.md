...
Voici mon premier projet graphique : créer un petit logiciel d'exploration de fractales ! Toujours en langage C.
Ce projet utilise uniquement le processeur avec la MinilibX.
Vous pouvez cloner le dépôt sur votre terminal pour visualiser par vous-même les fractales :
```
git clone https://github.com/Killianlr/fractol.git
cd fractol
make mlx && make
```
